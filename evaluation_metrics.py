...
def compute_all_scores(args, test_truth_label, softmax_scores,fpr_values):
    softmax_ccr, softmax_fpr, softmax_ccrs = EvaluationMetrics.ccr_at_fpr(test_truth_label, softmax_scores, fpr_values,
